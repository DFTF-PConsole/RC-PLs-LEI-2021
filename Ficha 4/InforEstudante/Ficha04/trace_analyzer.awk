...
#    Trace_analyzer.awk 
#
#    Copyright 2021 Vasco Pereira <vasco@dei.uc.pt>
#     
#
...
#
#  NOTE: if "Total transmission time" keeps returning 0 maybe you have a problem with locale; try running awk as:
#            >$ LC_ALL=C awk -f trace_analyzer.awk type=<x> src=<y> dest=<z> flow=<w> <trace_file>       
#
# =====================================================================================
#
# NS file format:
